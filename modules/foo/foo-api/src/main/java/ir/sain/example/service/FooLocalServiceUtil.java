...
package ir.sain.example.service;
 ...
 * <code>ir.sain.example.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>ir.sain.example.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ir.sain.example.model.Foo addFoo(
		ir.sain.example.model.Foo foo) {

		return getService().addFoo(foo);
	}

	public static ir.sain.example.model.Foo addFoo(
			long userId, String field1, boolean field2, int field3,
			java.util.Date field4, String field5,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().addFoo(
			userId, field1, field2, field3, field4, field5, serviceContext);
	}
	 ...
	 * @return the new foo
	 */
	public static ir.sain.example.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static ir.sain.example.model.Foo deleteFoo(
		ir.sain.example.model.Foo foo) {
	 ...
	 */
	public static ir.sain.example.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static ir.sain.example.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static ir.sain.example.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static ir.sain.example.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static ir.sain.example.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<ir.sain.example.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	public static java.util.List<ir.sain.example.model.Foo>
	...
	public static java.util.List<ir.sain.example.model.Foo>
		getFoosByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<ir.sain.example.model.Foo> orderByComparator) {
	 ...
	 */
	public static ir.sain.example.model.Foo updateFoo(
		ir.sain.example.model.Foo foo) {
