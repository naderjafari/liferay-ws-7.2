...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo addFoo(ir.sain.example.model.Foo foo) {
		return _fooLocalService.addFoo(foo);
	}

	@Override
	public ir.sain.example.model.Foo addFoo(
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo deleteFoo(ir.sain.example.model.Foo foo) {
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public ir.sain.example.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<ir.sain.example.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<ir.sain.example.model.Foo> getFoosByUuidAndCompanyId(
	 ...
	 */
	@Override
	public ir.sain.example.model.Foo updateFoo(ir.sain.example.model.Foo foo) {
