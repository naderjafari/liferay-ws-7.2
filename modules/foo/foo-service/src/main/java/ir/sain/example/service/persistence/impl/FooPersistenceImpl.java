...
package ir.sain.example.service.persistence.impl;
...
import ir.sain.example.exception.NoSuchFooException;
import ir.sain.example.model.Foo;
import ir.sain.example.model.impl.FooImpl;
import ir.sain.example.model.impl.FooModelImpl;
import ir.sain.example.service.persistence.FooPersistence;
import ir.sain.example.service.persistence.impl.constants.FOOPersistenceConstants;
...
public class FooPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.ir.sain.example.model.Foo"),
			true);
	}
