...
package ir.sain.example.service.persistence;
...
public class FooUtil {
	...
	public static Foo findByUuid_First(
		...
		throws ir.sain.example.exception.NoSuchFooException {
