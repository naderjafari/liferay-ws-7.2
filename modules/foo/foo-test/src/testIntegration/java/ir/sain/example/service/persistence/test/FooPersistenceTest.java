...
package ir.sain.example.service.persistence.test;
...
import ir.sain.example.service.FooLocalServiceUtil;
import ir.sain.example.service.persistence.FooPersistence;
import ir.sain.example.service.persistence.FooUtil;
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "ir.sain.example.service"));
